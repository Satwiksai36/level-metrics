...
export class HeuristicMappingService {
    ...
    static async inferLevel(params) {
        ...
        let matchedKeywordLevelName = null;
        ...
        const matchedLevel = normalizedLevels.find((nl) => nl.name.toLowerCase() === targetLevelName.toLowerCase());
        if (!matchedLevel) {
...
//# sourceMappingURL=heuristic-mapping.service.js.map