...
export class ComparisonService {
  private dataPointRepo = new DataPointRepository();
  ...
  async compareByLevelAndRole(params: {
    ...
    const getUSDConversionRate = (currency: string): number => {
    ...
    const companyGroups: Record<string, typeof processedPoints> = {};
